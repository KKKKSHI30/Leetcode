...
# 14.2 Data Structure for Graphs
#-----------nested Vertex class---------------
...
def shortest_path_lengths(g, src):
    ...
    pq = AdaptableHeapPriorityQueue()    # vertex v will have key d[v] in sec 9.55.2
...
def MST_PrimJarnik(g):
    ...
    # for each vertex v of the graph, add en entry to the priority queue; with
    # the source having distance 0 and all others having infinite distance
    for v in g.vertices():
...
def MST_Kruskal(g):
    ...
    The elements of the graph's edges are assumed to be wieghts.
    """
    tree = []    # list of edges in spanning tree
    pq = HeapPriorityQueue()    # entries are edges in G, with weights as key
    forest = Partition()        # keeps tract of forest clusters
